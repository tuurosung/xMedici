...
<main class="py-3 mx-lg-5">
	<div class="container-fluid mt-2">
		...
		<div class="row mb-5">
		  <div class="col-md-6">
		    <h4 class="titles montserrat">Pharmacists</h4>
		  </div>
		  <div class="col-md-6 text-right">
		    ...
		    $get_items=mysqli_query($db,"SELECT * FROM pharmacists WHERE subscriber_id='".$active_subscriber."' AND status='active'")  or die(mysqli_error($this->db));
		    $i=1;
		    while ($rows=mysqli_fetch_array($get_items)) {
					$pharm->pharm_id=$rows['pharm_id'];
					$pharm->PharmInfo();
		      ?>
					<li class="list-group-item hover pharmacists" id="<?php echo $rows['pharm_id']; ?>">
						<div class="row poppins">
						  <div class="col-md-1">
								<?php echo $i++; ?>
						  </div>
						  <div class="col-md-7">
								<?php echo $pharm->pharm_fullname; ?>
						  </div>
						  <div class="col-md-2">
								<?php echo $pharm->phone_number; ?>
						  </div>
								...
								<div class="dropdown open">
								  ...
								  <div class="dropdown-menu p-0 b-0  minioptions" aria-labelledby="dropdownMenu1">
								    <ul class="list-group">
								      ...
								      <li class="list-group-item suspend"  data-nurse_id="<?php echo $rows['nurse_id']; ?>">Suspend Account</li>
