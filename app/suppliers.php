...
<?php require_once '../navigation/admin_nav.php'; ?>
		...
		<main class="py-3 mx-lg-5">
			<div class="container-fluid mt-2">
				...
				<div class="row mb-5">
				  <div class="col-md-6">
				    	<h4 class="titles">Suppliers & Vendors</h4>
				  </div>
				  <div class="col-md-6 text-right">
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#new_supplier_modal">Create New</button>
				  </div>
				</div>
		      ...
		      <tbody>
		        ...
		        $get_items=mysqli_query($db,"SELECT * FROM suppliers WHERE subscriber_id='".$active_subscriber."'")  or die(mysqli_error($this->db));
		        $i=1;
