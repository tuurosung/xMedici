...
if (!isset($_SESSION['activePatientID']) || !isset($_SESSION['activeVisitID'])) {
...
$visit_id = $_SESSION['activeVisitID'];
$patient_id = $_SESSION['activePatientID'];
...
<div class="row d-none">
	<div class="col-md-6 mb-4 mb-md-0">
		<div class="form-group">
			...
			<input type="text" name="patient_id" id="activePatientID" class="form-control" placeholder="" value="<?php echo $patient_id; ?>">
		</div>
	</div>
	...
	<div class="col-md-6 mb-4 mb-md-0">
		<div class="form-group">
			...
			<input type="text" name="visit_id" id="activeVisitID" class="form-control" placeholder="" value="<?php echo $visit_id; ?>">
		</div>
	</div>
</div>
...
<div class="row mb-5">
	...
	<div class="col-8 text-right d-flex flex-row-reverse
		...
		<button type="button" name="button" class="btn btn-primary btn-rounded py-2
						...
						<?php
						if ($_SESSION['access_level'] == 'administrator' || $_SESSION['access_level'] == 'doctor') {
						} else {
							echo 'd-none';
						}
						?>	
		...
		<div class="dropdown open <?php if ($visit->visit_status != 'active') {
			...
			<button class="btn btn-primary py-2 dropdown-toggle
									<?php
									if ($_SESSION['access_level'] == 'administrator' || $_SESSION['access_level'] == 'doctor') {
									} else {
										echo 'd-none';
									...
									?>	
			" style="border-radius:10px" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		...
		<div class="tab-content" id="v-pills-tabContent">
			...
			<div class="tab-pane fade show active px-4" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
				<section>
					...
					<!-- Diagnosis History -->
					<div class="card br-1 my-5" style="min-height: 300px">
						<div class="card-body">
							...
							<div class="mt-5">
								...
								<h6 class="mt-5">Secondary Diagnosis</h6>
								...
								<table class="table">
									<tbody>
										...
										$sql = "SELECT * FROM patient_secondary_diagnosis";
										$sql .= " WHERE subscriber_id='" . $active_subscriber . "'AND patient_id='" . $patient_id . "' AND visit_id='" . $visit_id . "' AND status='active'";
										$r = $mysqli->query($sql);
						...
						<div class="col-md-6">
							<div class="card">
								<div class="card-body">
									...
									<form id="vitalsFrm" autocomplete="off">
									...
									<div class="tab-content">
										<div class="tab-pane fade show active pt-3" id="complains_content" role="tabpanel" aria-labelledby="complains_tab">
											...
											<section class="pr-4 mt-5">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<input type="text" name="complain" id="newComplain" class="form-control" value="" required>
														...
														<div class="col-md-3">
															<div class="form-group">
																...
																<input type="text" name="complain_duration" id="complainDuration" class="form-control" value="">
															</div>
														</div>
													</div>
												...
												<div class="mt-5" id="complains_holder">
													<!-- Complains table -->
													<table class="table table-condensed">
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td><?php echo $requests['results_status']; ?></td>
											<td>
...
<script type="text/javascript" src="../Includes/js/opd/opd.js"></script>
