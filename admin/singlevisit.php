			 ...
			 <div class="row mb-5">
				...
				">
					...
					<button type="button" name="button"  class="btn btn-primary btn-rounded py-2
						<?php if($visit->visit_status !='active'){ echo 'd-none'; } ?>
					...
					<button type="button" name="button" style="border-radius:10px"
					...
					<div class="dropdown open <?php if($visit->visit_status !='active'){ echo 'd-none'; } ?>">
									...
									<div class="card mb-5 d-none">
										<div class="card-body">
											...
											<section style="border-top:solid 1px #eaeaea" class="mt-5 py-4">
												...
												<div class="row poppins">
												  <div class="col-md-2">
														...
														<p class="montserrat font-weight-bold"><?php echo $vitals['systolic']; ?> / <?php echo $vitals['diastolic']; ?></p>
												  </div>
												  <div class="col-md-2">
														<p class="" style="font-size:11px">Weight</p>
														<p class="montserrat font-weight-bold"> <?php echo $vitals['weight']; ?> <sub>kg</sub></p>
												  </div>
												  <div class="col-md-2">
														<p class="" style="font-size:11px">Temperature</p>
														<p class="montserrat font-weight-bold"><?php echo $vitals['temperature']; ?> <sup>o</sup></p>
												  </div>
												  <div class="col-md-2">
														<p class="" style="font-size:11px">Pulse</p>
														<p class="montserrat font-weight-bold"><?php echo $vitals['pulse']; ?> BPM</p>
												  </div>
											...
											<section style="border-top:solid 1px #eaeaea" class="py-4">
												...
												<?php
													$get_log=mysqli_query($db,"SELECT *
																																				FROM visit_log
																																				WHERE
																																					visit_id='".$visit_id."' AND
																																					patient_id='".$patient_id."' AND
													...
													<h6 class="montserrat font-weight-bold">Patient Vitals Signs</h6>
														...
														<form id="patient_vitals_frm" autocomplete="off">
															...
															<div class="row">
																<div class="col-md-5">
																	<div class="form-group">
																		...
																		<input type="text" name="systolic" class="form-control" placeholder="" required  value="<?php echo $vitals['systolic']; ?>">
																	</div>
																</div>
																<div class="col-md-2">
																	<div class="form-group">
																...
																<div class="col-md-5">
																	<div class="form-group">
																		...
																		<input type="text" name="diastolic" class="form-control" placeholder="" required  value="<?php echo $vitals['diastolic']; ?>">
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<input type="text" name="pulse" class="form-control" placeholder=""  value="<?php echo $vitals['pulse']; ?>">
															</div>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" name="temperature" class="form-control" placeholder=""  value="<?php echo $vitals['temperature']; ?>">
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="">Weight</label>
																		<input type="text" name="weight" class="form-control" value="<?php echo $vitals['weight']; ?>">
																	</div>
																</div>
															</div>
															...
															<button type="submit" class="btn btn-primary wide b-0 <?php if($visit->visit_status !='active'){ echo 'd-none'; } ?>">Record Vitals</button>
											...
											<div class="card mb-3">
												<div class="card-body px-1">
													...
													<div class="grey lighten-3 p-3">
														...
														<p class="font-weight-bold m-0 montserrat"><?php echo $vitals['systolic']; ?> / <?php echo $vitals['diastolic']; ?></p>
														Blood Pressure

														<hr>

														<p class="font-weight-bold m-0 montserrat"><?php echo $vitals['weight']; ?><sub>kg</sub></p>
														Weight

														<hr>

														<p class="font-weight-bold m-0 montserrat"><?php echo $vitals['temperature']; ?><sup>o</sub></p>
														Temperature
														<hr>

														<p class="font-weight-bold m-0 montserrat"><?php echo $vitals['pulse']; ?> BPM</p>
														Pulse
																...
																<hr class="hr" style="width:30%; margin-left:0px">
																	...
																	<section class="pr-4 mt-5">
																		<form id="record_complain_frm" autocomplete="off">
																			...
																			<button type="submit" class="btn btn-primary wide m-0 <?php if($visit->visit_status !='active'){ echo 'd-none'; } ?>">Add Complain</button>
																		</form>
															...
															<div class="tab-pane fade pt-3"  id="odq_content" role="tabpanel"  aria-labelledby="odq_tab">
																...
																<section class="pr-4 mt-5">
																	<form id="record_odq_frm" autocomplete="off">
																		...
																		<button type="submit" class="btn btn-primary wide m-0 <?php if($visit->visit_status !='active'){ echo 'd-none'; } ?>">Save ODQ</button>
																	</form>
															...
															<div class="tab-pane fade pt-3"  id="hpc_content" role="tabpanel"  aria-labelledby="hpc_tab">
																...
																<section class="pr-4 mt-5">
																	<form id="hpc_frm" autocomplete="off">
																		...
																		<button type="submit" class="btn btn-primary wide m-0 <?php if($visit->visit_status !='active'){ echo 'd-none'; } ?>">Record HPC</button>
																	</form>
											...
											<div class="px-3 py-3 grey lighten-4">
												<?php
													...
													while ($bills=mysqli_fetch_array($get_bills)) {
														...
														$billing->BillInfo();
														?>
														<div class="card mb-1 cursor <?php if($billing->payment_status !='PAID'){ echo 'payment_btn'; } ?>" id="<?php echo $bills['bill_id']; ?>">
															<div class="card-body py-2">
																<div class="row poppins" style="font-size:11px">
																	<div class="col-8">
      ...
      <div class="modal-body p-0">
        <ul class="list-group">
          ...
          <li class="list-group-item" data-toggle="collapse" data-target="#vital_signs_sub" aria-expanded="true" aria-controls="vital_signs_sub">
						Record Vital Signs
						<i class="fas fa-chevron-down float-right"></i></li>
