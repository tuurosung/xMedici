...
<main class="py-5 ml-lg-5 main" style="">
  <div class="container-fluid mt-2">
          ...
          <div class="col-md-6">
              <div class="card">
                <div class="card-body">
                  <h6>New Patients</h6>
                  <div class="row">
                    <div class="col-6"><h3 class="montserrat text-success" style="font-weight:600">0</h3></div>
    ...
    <section class="my-5 d-none">
      <h4 class="montserrat font-weight-bold mb-4">Overview</h4>

      <div class="d-flex">
        <div class="card mr-3" style="border-radius:30px; width:200px; height:200px">
          <div class="card-body">
            <img src="../images/outpatient.svg" alt="" style="height:50px">
            <p class="poppins text-muted mt-4 mb-3" style="font-size:16px">Out-Patients</p>
            <h4 class="montserrat" style="font-weight:600"><?php echo $visit->active_opd_cases; ?></h4>
          </div>
        </div>
        <div class="card mr-3" style="border-radius:30px; width:200px">
          <div class="card-body">
            <img src="../images/inpatient.svg" alt="" style="height:50px">
            <p class="poppins text-muted mt-4 mb-3" style="font-size:16px">In-Patients</p>
            <h4 class="montserrat" style="font-weight:600"><?php echo $admission->active_admissions; ?></h4>
          </div>
        </div>
        <div class="card mr-3" style="border-radius:30px; width:200px">
          <div class="card-body">
            <img src="../images/mypatients.svg" alt="" style="height:50px">
            <p class="poppins text-muted mt-4 mb-3" style="font-size:16px">My Patients</p>
            <h4 class="montserrat" style="font-weight:600">
              <?php

              $countmypatients=mysqli_query($db,"SELECT COUNT(*) as mypatients FROM patients WHERE user_id='".$active_user."'") or die(mysqli_error($db));
              $countmypatients=mysqli_fetch_array($countmypatients);
              echo $countmypatients['mypatients'];
