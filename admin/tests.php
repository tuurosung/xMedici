 ...
 ?>
		...
		<main class="py-3 ml-lg-5 main" style="background-color:; min-height:100vh">
			<div class="container-fluid mt-2">
				...
				<div class="row">
				  <div class="col-md-6 ">
						<h4 class="titles montserrat mb-5">Laboratory Tests</h4>
				  </div>
				...
				<div class="card">
					<div class="card-body py-5">
						...
						<div class="row mb-5">
						  <div class="col-4">
								<h6 class="font-weight-bold montserrat">Test Catalogue</h6>
						  </div>
						  <div class="col-8 d-flex flex-row-reverse">
								<select class="custom-select browser-default" name="test_category" style="width:200px">
									<option value="">Filter By Category</option>
									<?php
									$test=new Test();
									$test_categories=mysqli_query($db,"SELECT * FROM lab_test_categories WHERE status='active' && subscriber_id='system'")  or die(mysqli_error($db));
									$i=1;
									while ($rows=mysqli_fetch_array($test_categories)) {
										?>
