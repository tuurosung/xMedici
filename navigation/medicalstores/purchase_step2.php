            ...
            <div class="container-fluid">
							...
							<div class="row">
							  <div class="col-md-12">
									<div class="card">
										<div class="header">
											<h4 class="title">Purchase Step 2</h4>
											<p class="category">
												Basic Details
											</p>
										</div>
											...
											<div class="row">
											  <div class="col-md-4 table-responsive">
												...
												<div class="col-md-8">
													...
													<div class="row">
													  <div class="col-md-6">
															<input type="text" name="supply_price" id="supply_price" class="form-control" placeholder="Supply Price" required >
													  </div>
													  <div class="col-md-6">
															<input type="text" name="qty" id="qty" class="form-control" placeholder="Qty Purchased" required >
													  </div>
													</div>
													<br>
													<div class="row" style="margin-bottom:30px">
													  <div class="col-md-6">
															<input type="text" name="cost" id="cost" class="form-control" placeholder="Cost" required readonly>
													  </div>
													  <div class="col-md-6">
    	...
    	$(document).ready(function(){
	            ...
	            $('#purchase_id').val(text)
						...
						$('#counter_frm').on('submit', function(event) {
							...
							if(con===true){
								$.ajax({
									url: '../serverscripts/medicalstores/purchase_addtolist.php',
									type: 'GET',
									data:$(this).serialize(),
									success: function(msg){
										if(msg==='save_successful'){
						...
						function purchased_items(){
							$.ajax({
								url: '../serverscripts/medicalstores/purchaseditems_list_tmp.php',
								type: 'GET',
								success: function(msg){
									$('#listholder').html(msg)
								}
						...
						$('#proceed').on('click', function(event) {
							...
							if(con===true){
								window.location='purchase_step3.php'
							}
						});
